...
class EmployeeJobDetails extends StatefulWidget {
  const EmployeeJobDetails({super.key});

  @override
  State<EmployeeJobDetails> createState() => _EmployeeJobDetailsState();
}

class _EmployeeJobDetailsState extends State<EmployeeJobDetails> {
